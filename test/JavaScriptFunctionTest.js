...
test("JavaScript Function Diff #76", async t => {
  ...
  t.is(json.length, 1);
  let rendered = json[0].content;
	t.is(rendered, `<pre class="language-diff"><code class="language-diff"><span class="token deleted-sign deleted"><span class="token prefix deleted">-</span>var test;</span></code></pre>
<pre class="language-diff-js"><code class="language-diff-js"><span class="token deleted-sign deleted language-js"><span class="token prefix deleted">-</span><span class="token keyword">var</span> test<span class="token punctuation">;</span></span></code></pre>`);
});
